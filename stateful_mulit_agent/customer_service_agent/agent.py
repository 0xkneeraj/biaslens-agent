...
from .sub_agents.support_agent.agent import support_agent
...
customer_service_agent = Agent(
    ...
    **Core Capabilities:**
    ...
    2. State Management
       ...
       - Monitor user's purchased courses in state['purchased_history']
    ...
    **Interaction History:**
    ...
    """,
    sub_agents=[policy_agent, sales_agent, support_agent, order_agent],
    tools=[],
)